  ...
  return (
    ...
    >
      <Div px={20} pr={0} h={"100%"} flexDir="column" justifyContent="space-between">
        <Div mt={25}>
          <SvgXml xml={logoSvg} width={250} height={45} />
        </Div>
