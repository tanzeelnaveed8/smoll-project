      ...
      {!loading && (
        <View style={{ flex: 1, justifyContent: "space-between" }}>
          <View>
            ...
            <Div flexDir="row" alignSelf="center" mt={50} mb={40}>
              <Div flexDir="row" alignItems="center">
                <Image source={require("@/assets/images/congratulation-tick.png")} w={52} h={52} />
                <Div h={42} ml={12}>
                  <Image source={require("@/assets/icons/smollcare-logo.png")} w={132} h={24} />
